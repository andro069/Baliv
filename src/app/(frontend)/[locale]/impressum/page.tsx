...
import { impressumDefaults as D } from '@/globals/Rechtstexte/config'
...
async function lade(locale: Locale) {
  try {
    ...
    return (await payload.findGlobal({ slug: 'impressum-page', locale, depth: 0 } as any)) as any
  } catch {
    return null
  }
}
  ...
  return (
    <main className="bg-[#F0EDE8]" style={{ fontFamily: 'var(--font-raleway), sans-serif' }}>
      ...
      <Rechtstext
        ...
        stand={typeof cms?.stand === 'string' ? cms.stand : null}
        abschnitte={abschnitte}
        inhaltClassName="prose prose-sm max-w-none space-y-10 text-[#151E39]/80 leading-relaxed"
      />
